...
######################################
    ...
    PS1='\[\e[0m\]\[$prevCmd\]>\[$RST\]${debian_chroot:+($debian_chroot)}\[\033[36m\]\u\[\033[m\]@\[\033[32m\]\h:\[\033[33;1m\]\w\[\033[m\]\$ '
else
...
#Checks if tree is intalled and defines different aliases
if debInst tree
then
    ...
    alias treed="ls -R | grep :*/ | grep ":$" | sed -e 's/:$//' -e 's/[^-][^\/]*\//--/g' -e 's/^/   /' -e 's/-/|/'"
fi
...
#User added variable
export JAVA_HOME=/home/agneypatel/Distros/jdk1.8.0_202
export MAVEN_HOME=/home/agneypatel/Distros/apache-maven-3.9.6
export PATH=$JAVA_HOME/bin:$MAVEN_HOME/bin:$PATH

#sbin commands folder
